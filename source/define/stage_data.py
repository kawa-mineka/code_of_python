...
class stage_data:
    ...
    def event_list(self):          #各ステージのイベントリストの定義
        ...
        self.event_list_stage_mountain_region_l1= [
            ...
            [ 200,EVENT_ENEMY,EnemyName.CIR_COIN    ,160, 40   ,6],
            ...
            [ 403,EVENT_ENEMY,EnemyName.CIR_COIN    ,160, 70   ,6],
            [ 450,EVENT_SCROLL,SCROLL_NUM_SET,  3.5,0.5,        0.5,0.01],
            [ 500,EVENT_SCROLL,SCROLL_NUM_SET,    4,0.5,        0.5,0.01],
            [ 550,EVENT_ENEMY,EnemyName.CIR_COIN    ,160, 40   ,6],
            [ 600,EVENT_SCROLL,SCROLL_NUM_SET,    5,0.5,        0.5,0.01],
            [ 690,EVENT_ENEMY,EnemyName.CIR_COIN    ,160, 70   ,6],
            [ 700,EVENT_SCROLL,SCROLL_NUM_SET,    6,0.5,        0.5,0.01],
            [ 800,EVENT_SCROLL,SCROLL_NUM_SET,    7,0.5,        0.5,0.01],
            [ 891,EVENT_ENEMY,EnemyName.SAISEE_RO,170, 50-10],
            [ 892,EVENT_ENEMY,EnemyName.SAISEE_RO,169, 50   ],
            [ 893,EVENT_ENEMY,EnemyName.SAISEE_RO,168, 50+10],
            [ 900,EVENT_SCROLL,SCROLL_NUM_SET,    8,0.5,        0.5,0.01],
            
            [ 910,EVENT_BG_SCREEN_ON_OFF,BG_BACK,DISP_ON],
            
            [ 951,EVENT_ENEMY,EnemyName.SAISEE_RO,170, 50-20],
            [ 952,EVENT_ENEMY,EnemyName.SAISEE_RO,169, 50   ],
            [ 953,EVENT_ENEMY,EnemyName.SAISEE_RO,168, 50+20],
            
            [1000,EVENT_CLOUD,CLOUD_NUM_SET,6,1,-0.25,1],
            [1010,EVENT_CLOUD,CLOUD_START],
            
            [1051,EVENT_ENEMY,EnemyName.SAISEE_RO,170, 50-30],
            [1052,EVENT_ENEMY,EnemyName.SAISEE_RO,169, 50-20],
            [1053,EVENT_ENEMY,EnemyName.SAISEE_RO,168, 50   ],
            [1054,EVENT_ENEMY,EnemyName.SAISEE_RO,167, 50+20],
            [1055,EVENT_ENEMY,EnemyName.SAISEE_RO,166, 50+30],
            
            [1100,EVENT_ENEMY,EnemyName.SAISEE_RO,170, 30   ],
            [1110,EVENT_ENEMY,EnemyName.SAISEE_RO,170, 30   ],
            [1120,EVENT_ENEMY,EnemyName.SAISEE_RO,170, 30   ],
            [1130,EVENT_ENEMY,EnemyName.SAISEE_RO,170, 30   ],
            [1140,EVENT_ENEMY,EnemyName.SAISEE_RO,170, 30   ],
            [1150,EVENT_ENEMY,EnemyName.SAISEE_RO,170, 30   ],
            [1160,EVENT_ENEMY,EnemyName.SAISEE_RO,170, 30   ],
            [1170,EVENT_ENEMY,EnemyName.SAISEE_RO,170, 30   ],
            [1180,EVENT_ENEMY,EnemyName.SAISEE_RO,170, 30   ],
            
            [1300,EVENT_ENEMY,EnemyName.SAISEE_RO,170, 70   ],
            [1310,EVENT_ENEMY,EnemyName.SAISEE_RO,170, 70   ],
            [1320,EVENT_ENEMY,EnemyName.SAISEE_RO,170, 70   ],
            [1330,EVENT_ENEMY,EnemyName.SAISEE_RO,170, 70   ],
            [1340,EVENT_ENEMY,EnemyName.SAISEE_RO,170, 70   ],
            [1350,EVENT_ENEMY,EnemyName.SAISEE_RO,170, 70   ],
            [1360,EVENT_ENEMY,EnemyName.SAISEE_RO,170, 70   ],
            [1370,EVENT_ENEMY,EnemyName.SAISEE_RO,170, 70   ],
            [1380,EVENT_ENEMY,EnemyName.SAISEE_RO,170, 70   ],
            
            [1451,EVENT_ENEMY,EnemyName.SAISEE_RO,170, 10   ],
            [1452,EVENT_ENEMY,EnemyName.SAISEE_RO,169, 20   ],
            [1453,EVENT_ENEMY,EnemyName.SAISEE_RO,168, 30   ],
            [1454,EVENT_ENEMY,EnemyName.SAISEE_RO,167, 40   ],
            [1455,EVENT_ENEMY,EnemyName.SAISEE_RO,166, 50   ],
            [1456,EVENT_ENEMY,EnemyName.SAISEE_RO,165, 60   ],
            [1457,EVENT_ENEMY,EnemyName.SAISEE_RO,164, 70   ],
            [1458,EVENT_ENEMY,EnemyName.SAISEE_RO,163, 80   ],
            [1459,EVENT_ENEMY,EnemyName.SAISEE_RO,162, 90   ],
            ...
            [1561,EVENT_ENEMY,EnemyName.SAISEE_RO,170, 10   ],
            [1562,EVENT_ENEMY,EnemyName.SAISEE_RO,169, 20   ],
            [1563,EVENT_ENEMY,EnemyName.SAISEE_RO,168, 30   ],
            [1564,EVENT_ENEMY,EnemyName.SAISEE_RO,167, 40   ],
            [1565,EVENT_ENEMY,EnemyName.SAISEE_RO,166, 50   ],
            [1566,EVENT_ENEMY,EnemyName.SAISEE_RO,165, 60   ],
            [1567,EVENT_ENEMY,EnemyName.SAISEE_RO,164, 70   ],
            [1568,EVENT_ENEMY,EnemyName.SAISEE_RO,163, 80   ],
            [1569,EVENT_ENEMY,EnemyName.SAISEE_RO,162, 90   ],
            
            [1600,EVENT_CLOUD,CLOUD_NUM_SET,6,2,-0.4,1],
            
            [1610,EVENT_ENEMY,EnemyName.VOLDAR,168, 0],
            
            
            [1710,EVENT_ENEMY,EnemyName.RAY_BLASTER,168, 40-20],
            [1720,EVENT_ENEMY,EnemyName.RAY_BLASTER,168, 40   ],
            [1730,EVENT_ENEMY,EnemyName.RAY_BLASTER,168, 40+20],
            
            [1810,EVENT_ENEMY,EnemyName.RAY_BLASTER,168, 60-20],
            [1850,EVENT_ENEMY,EnemyName.RAY_BLASTER,168, 60   ],
            [1890,EVENT_ENEMY,EnemyName.RAY_BLASTER,168, 60+20],
            ...
            [2340,EVENT_ENEMY,EnemyName.TWIN_ARROW,160,  20],
            [2341,EVENT_ENEMY,EnemyName.TWIN_ARROW,160,  60],
            [2342,EVENT_ENEMY,EnemyName.TWIN_ARROW,160, 100],
            
            [2600,EVENT_ENEMY,EnemyName.TWIN_ARROW,160, 60   ],
            [2601,EVENT_ENEMY,EnemyName.TWIN_ARROW,160, 60+10],
            [2602,EVENT_ENEMY,EnemyName.TWIN_ARROW,160, 60-10],
            [2603,EVENT_ENEMY,EnemyName.TWIN_ARROW,160, 60+20],
            [2604,EVENT_ENEMY,EnemyName.TWIN_ARROW,160, 60-20],
            
            [2740,EVENT_ENEMY,EnemyName.TWIN_ARROW,120,  -8],
            [2741,EVENT_ENEMY,EnemyName.TWIN_ARROW,160, 60],
            [2742,EVENT_ENEMY,EnemyName.TWIN_ARROW,120,  130],
            
            [2840,EVENT_ENEMY,EnemyName.TWIN_ARROW,120,  -8],
            [2841,EVENT_ENEMY,EnemyName.TWIN_ARROW,80,  -8],
            [2842,EVENT_ENEMY,EnemyName.TWIN_ARROW,160, 60],
            [2843,EVENT_ENEMY,EnemyName.TWIN_ARROW,80,  130],
            [2844,EVENT_ENEMY,EnemyName.TWIN_ARROW,120,  130],
        ...
        self.event_list_stage_nightskyscraper_l1= [
            ...
            [  20,EVENT_SCROLL,SCROLL_NUM_SET,   4  ,0.05,         0.7 ,  0.03],
            [  90,EVENT_SCROLL,SCROLL_NUM_SET,   3.5  ,-0.01,         0.3 ,  0.02],
            [ 120,EVENT_SCROLL,SCROLL_NUM_SET,   3.5  ,-0.01,         0.2 ,-0.005],
            [ 185,EVENT_SCROLL,SCROLL_NUM_SET,   2.5  ,-0.01,         0.1 ,-0.007],
    ...
    def bg_animation_pre_define_list(self):   #各ステージのＢＧ書き換えによるアニメーション(書き換えるマップチップ指定しBGマップの任意の範囲を調査し座標を登録記録していくタイプ)の為のデータリスト群の定義
        ...
        #             描画枚数,描画枚数オフセット値,スピード(1なら1フレームに1コマ),タイルマップ番号,BGパターンが収納されている座標u(横),BGパターンが収納されている座標v(縦),W(キャラクター単位横幅),h(キャラクター単位縦幅)],
        #            
        #            [BG書き換えアニメーションを行いたい矩形画像の左上の座標を示すマップチップアスキーコード+1
        #             描画枚数,描画枚数オフセット値,スピード(1なら1フレームに1コマ),タイルマップ番号,BGパターンが収納されている座標u(横),BGパターンが収納されている座標v(縦),W(横幅kキャラクター単位),h(縦幅キャラクター単位)],
        #             
        #            [BG書き換えアニメーションを行いたい矩形画像の左上の座標を示すマップチップアスキーコード+2
        #             描画枚数,描画枚数オフセット値,ピード(1なら1フレームに1コマ),タイルマップ番号,BGパターンが収納されている座標u(横),BGパターンが収納されている座標v(縦),W(横幅キャラクター単位),h(縦幅キャラクター単位)],
        #            
